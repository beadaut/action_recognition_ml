...
def train():
    ...
    with tf.Graph().as_default():
        ...
        train_data_gen = DataGenerator(
            training_filenames, training_labels, batch_size=cfg.batch_size, augment=False, steps=10)
        validation_data_gen = DataGenerator(
            validation_filenames, validation_labels, batch_size=cfg.batch_size, augment=False, steps=10)
