...
from utils.data_from_vid_generator import DataGenerator
...
def train():
    ...
    with tf.Graph().as_default():
        ...
        # %%
        training_filenames = np.load(
            '/media/tjosh/vault/chalearn_dataset/IsoGR_2016/train_filenames_2.npy')
            # 'dataset/IsoGR_2016/train_filenames.npy')
        training_labels = np.load(
            '/media/tjosh/vault/chalearn_dataset/IsoGR_2016/train_labels_2.npy')
            # 'dataset/IsoGR_2016/train_labels.npy')
        validation_filenames = np.load(
            '/media/tjosh/vault/chalearn_dataset/IsoGR_2016/train_validation_filenames_2.npy')
            # 'dataset/IsoGR_2016/train_validation_filenames.npy')
        validation_labels = np.load(
            '/media/tjosh/vault/chalearn_dataset/IsoGR_2016/train_validation_labels_2.npy')
            # 'dataset/IsoGR_2016/train_validation_labels.npy')
        training_filenames = np.append(training_filenames, validation_filenames, axis=0)
        training_labels = np.append(training_labels, validation_labels, axis=0)

        # print("new shape of files", np.shape(training_filenames))
        # raise
        ...
        for epoch in range(1, cfg.epoch+1):
            ...
            print("Current learning rate= ",learning_rate.eval(session=sess))
