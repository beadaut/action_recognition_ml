...
def test_distance():
    ...
    with tf.Graph().as_default():
        ...
        # load_model_path = LOGDIR+'/model_epoch_{}'.format(cfg.load_model_epoch)
        # load_model_path = '/media/tjosh/vault/MSRAction3D/trained_models/logdir_one_shot_only_2_simple_ff_5_96/model_epoch_85'
        load_model_path = '/media/tjosh/vault/MSRAction3D/trained_models/logdir_one_shot_only_2_simple_ff_5_96/model_epoch_85'
        load_model_path = 'logdir_one_shot_re_simple_ff_5_96/model_epoch_20'
        saver = tf.train.Saver()
        saver.restore(sess, load_model_path)
        print("\nModel restored...", load_model_path)
        print("\n\n\n")
