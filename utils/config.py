...
flags.DEFINE_float('init_learning_rate', 0.00005, 'initial learning rate')
...
# flags.DEFINE_string('logdir', 'logdir_one_shot_re_2_', 'logs directory')
flags.DEFINE_string('logdir', 'logdir_multitask_re_', 'logs directory')
...
flags.DEFINE_string('load_model_epoch', '35', 'epoch to load model from')
