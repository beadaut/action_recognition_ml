...
flags.DEFINE_integer('num_frames', 10, 'number of frames')
flags.DEFINE_integer('num_classes', 249, 'number of classes')

# for training
flags.DEFINE_integer('batch_size', 128, 'batch size')
flags.DEFINE_integer('im_dim', 96, 'input_image dimension')
flags.DEFINE_integer('epoch', 120, 'epoch')
flags.DEFINE_float('init_learning_rate', 0.00003, 'initial learning rate')
flags.DEFINE_integer('decay_step', 50*26000, 'decay step') # 20Xdataset_size (or 30X) has worked well
...
flags.DEFINE_string('logdir', 'logdir_chalearn_lr_', 'logs directory')
...
flags.DEFINE_string('load_model_epoch', '180', 'epoch to load model from')
