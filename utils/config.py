...
flags.DEFINE_integer('epoch', 80, 'epoch')
flags.DEFINE_float('init_learning_rate', 0.0001, 'initial learning rate')
flags.DEFINE_integer('decay_step', 20*10000, 'decay step') # 20Xdataset_size has worked well
...
flags.DEFINE_string('logdir', 'logdir_set_1_', 'logs directory')
