...
def pick_triplet(labels_in, seek_anchor=None, seek_neg=None):
  """
  Randomly picks a triplet consisting of an anchor, negaive and positive label
  """
...
def test_triplet_generator():
  ...
  dataset_glob_path = "dataset/hand_controls_npy_4_1024/**/*.npy"
  train_dataset, validation_dataset = load_npy_filenames(
      dataset_glob_path, validation_split=0.2)
  batch_size = 10
  test_data = TripletGenerator(
      train_dataset, 6, batch_size=batch_size)
